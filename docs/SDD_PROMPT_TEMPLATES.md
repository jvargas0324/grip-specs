...
Uso recomendado: copiar la plantilla que corresponda al chat o Composer, sustituir los marcadores y **citar siempre los SSOT con `@`** (por ejemplo `@specs/GRIP-SDD-Functional-Specs.md`) para que el modelo cargue el contrato antes de codificar.
...
- specs/GRIP-SDD-Functional-Specs.md
- specs/GRIP-SDD-Functional-Specs.md (si cambian journeys o índice R1–R6)
...
- Si afecta a reglas R1–R6 o versión global, indica qué actualizar en specs/backend_audit_report.md y el campo Versión en GRIP-SDD-Functional-Specs.md según el flujo del proyecto.
```
...
- specs/GRIP-SDD-Functional-Specs.md (API, R1–R6, stack)
...
- Llamadas a Gemini: try/except y degradación según GRIP-SDD-Functional-Specs.md §3 y §3.F.
```
...
- specs/GRIP-SDD-Functional-Specs.md (reconciliar Versión si el contrato o R1–R6 cambiaron)
- specs/GRIP-SDD-Functional-Specs.md §6.0 si el índice R1–R6 funcional debe actualizarse
...
| Documento | Rol |
|-----------|-----|
| `specs/GRIP-SDD-Functional-Specs.md` | Contrato técnico, R1–R6, API, DB |
| `specs/GRIP-SDD-Functional-Specs.md` | Journeys, índice R1–R6 funcional |
